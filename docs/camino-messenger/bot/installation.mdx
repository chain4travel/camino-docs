...
When you access our github repository, the default branch is "dev". always
switch to the latest version using the tags or using "latest".
...
to pull a certain version, replace latest with the version number eg: v10.1.0
...
- **Cancellation is not yet implemented:** The bot Does not have the cancellation
  messages implemented that are already released in V11 of the protocol. Cancellation
  will be included in one of the next releases of the bot.
