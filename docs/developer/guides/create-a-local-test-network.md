...
The below commands assume you have [Camino-Node](/camino-node/set-up-node-manual-installation.md#download-camino-node) installed at `$GOPATH/src/github.com/chain4travel/camino-node`. Each of the five nodes created is a validator.
