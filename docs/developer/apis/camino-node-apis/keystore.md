...
For validation and delegation on main net, you should issue transactions through [the wallet](https://wallet.camino.foundation). That way control keys for your funds won't be stored on the node, which significantly lowers the risk should a computer running a node be compromised.
